        ...
        <header>
            <nav class="nav-collapse">
                <ul>
                    ...
                    <li class="menu-item"><a href="#sair" data-open="exampleModal1" data-scroll>Sair</a></li>
        ...
        <?php if (isset($_SESSION['success'])) { ?>
            ...
            <?php
                ...
                <?php echo $_SESSION['username']; ?>
                    <br>
                    <br> <a href="<?php echo base_url(); ?>index.php/Entrar/logout" class="button">Logout</a> </div>
    <button class="close-button" data-close aria-label="Close reveal" type="button"> <span aria-hidden="true">&times;</span> </button>
    </div>
    <div class="row align-center container">
        <div class="small-12 small-centered text-center columns"><h1 class="invisible">AskCine</h1><img src="../../assets/img/blank.png" alt="logo AskCine"></div>
    </div>
    <!-- //FIM DO HEADER -->
    <!-- //BUSCA -->
    <form>
...
<br>
 ...
 <div class="column"> <img src="../../assets/img/posters/poster1.jpg" class="thumbnail" alt=""> <p class="caixa">Doutor Estranho - 2016</p></div>
        <div class="column"> <img src="../../assets/img/posters/poster2.jpg" class="thumbnail" alt=""> <p class="caixa">Jack Reacher - 2016</p> </div>
        <div class="column"> <img src="../../assets/img/posters/poster3.jpg" class="thumbnail" alt=""> <p class="caixa">Inferno - 2016</p> </div>
        <div class="column"> <img src="../../assets/img/posters/poster4.jpg" class="thumbnail" alt=""> <p class="caixa">O Contador - 2016</p> </div>
