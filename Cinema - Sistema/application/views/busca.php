...
<body>
    ...
    <div class="row small-10 small-up-1 medium-up-2 large-up-4 small-centered text-center">
        <div class="column"> <img src="img/posters/poster1.jpg" class="thumbnail" alt="">
            <p class="caixa">Doutor Estranho - 2016</p>
        </div>
        <div class="column"> <img src="img/posters/poster2.jpg" class="thumbnail" alt="">
            <p class="caixa">Jack Reacher - 2016</p>
        </div>
        <div class="column"> <img src="img/posters/poster3.jpg" class="thumbnail" alt="">
            <p class="caixa">Inferno - 2016</p>
        </div>
        <div class="column"> <img src="img/posters/poster4.jpg" class="thumbnail" alt="">
            <p class="caixa">O Contador - 2016</p>
        </div>
        <div class="column"> <img src="img/posters/poster1.jpg" class="thumbnail" alt="">
            <p class="caixa">Doutor Estranho - 2016</p>
        </div>
